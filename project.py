PatientAppointments = {
    1: ["Anas", "2023-10-01", "10:00"],
    2: ["Sara", "2023-10-02", "11:00"],
    3: ["Amal", "2023-10-03", "12:00"],
    4: ["Rami", "2023-10-04", "13:00"]
}
    ...
    if choice == "1":
        ...
        if not PatientAppointments:
            ...
            if remove_key in PatientAppointments:
                ...
                print("🗑️ Appointment deleted successfully!")
            else:
                print("⚠️ No appointment with that number.")
